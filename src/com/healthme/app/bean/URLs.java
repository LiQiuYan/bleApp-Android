...
public class URLs implements Serializable {
	...
	public final static String ECG_SERVER = "192.168.1.177";//192.168.1.213  www.oschina.net
	public final static String ECG_HOST = "192.168.1.177";//192.168.1.213  www.oschina.net
	public final static String HOST = "www.healthme.com.cn";//192.168.1.213  www.oschina.net
	...
	//private final static String URL_API_ECG_HOST = HTTP + ECG_HOST + URL_SPLITTER;
	
	//for test
	private final static String URL_API_HOST = "http://192.168.1.177:8001/";
	private final static String URL_API_ECG_HOST = "http://192.168.1.177:8001/";
	
	public final static String WS_API_HOST = "ws://192.168.1.177:8001/healthme/websocket/";
	
//	public final static String ECG_GET_USER=URL_API_ECG_HOST+"userform/getUser?name=";
	public final static String ECG_CURRENT_USER=URL_API_ECG_HOST+"currentPatient";
	public final static String ECG_GET_ECG_RECORD_LIST=URL_API_ECG_HOST+"recordHistory";
	public final static String ECG_GET_ECG_RECORD=URL_API_ECG_HOST+"recordDetail";
	public final static String ECG_GET_ECGCLASSIFICATION_LIST=URL_API_ECG_HOST+"ecgclassificationList";
	public final static String ECG_GET_ECG_RAW=URL_API_ECG_HOST+"rawMedicalRecord";
	public final static String ECG_GET_ECG_DEFECT_LIST=URL_API_ECG_HOST+"userhealth/getDefectListPage";
//	public final static String ECG_GET_ECG_SAMPLES=URL_API_ECG_HOST+"userhealth/geSamples";
	public final static String ECG_CREATE_SESSION=URL_API_ECG_HOST+"patient/createTransferSession";
	public final static String ECG_SEND_DATA=URL_API_ECG_HOST+"patient/transferECGData";
	public final static String ECG_ADD_RELATIVE=URL_API_ECG_HOST+"patient/addRelative";
	public final static String ECG_DEL_RELATIVE=URL_API_ECG_HOST+"patient/delRelative";
	public final static String ECG_GET_RELATIVES=URL_API_ECG_HOST+"patient/getRelatives";
	
	public final static String USER_CHECK_PARAM=URL_API_ECG_HOST+"patient/register/checkParam";
	public final static String USER_REGISTER=URL_API_ECG_HOST+"patient/register/doRegister";
	public final static String USER_CHANGE_PASSWORD=URL_API_ECG_HOST+"patient/register/changePassword";
	public final static String USER_SEND_SMS=URL_API_ECG_HOST+"patient/register/sendSMSCode";
	
	public final static	String JSECCHKURL_HTTP = URL_API_HOST + "j_security_check";
	public final static	String JSECCHKURL_HTTP_OK = URL_API_HOST + "home";
	
//	public final static String LOGIN_VALIDATE_HTTP = HTTP + HOST + URL_SPLITTER + "j_security_check";

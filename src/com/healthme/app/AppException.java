...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	public final static byte TYPE_RELOGIN		= 0x08;
	...
	public void makeToast(Context ctx){
		...
		case TYPE_RUN:
			...
			break;
		case TYPE_RELOGIN:
			Toast.makeText(ctx, R.string.app_relogin_error, Toast.LENGTH_SHORT).show();
			break;
		}
	}
	...
	public static AppException relogin(Exception e) {
		return new AppException(TYPE_RELOGIN, 0, e);
	}
